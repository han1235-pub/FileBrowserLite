...
public class FileSystem
{
    ...
    //upload folder at destination given
    ...
    //open stream and browser will do the rest
    ...
    //retrieve all files and folders at a given folder
    ...
    //get all files and folders that matched with the search term
